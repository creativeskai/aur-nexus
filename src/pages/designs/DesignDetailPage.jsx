...
export default function DesignDetailPage() {
  ...
  const canEdit = (profile?.role === 'designer' && design.designer_id === profile?.id || profile?.role === 'admin') &&
    ['draft','submitted','under_review','revision_requested','resubmitted'].includes(design.status)
